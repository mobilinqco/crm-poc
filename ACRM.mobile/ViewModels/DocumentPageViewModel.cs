...
{
    public class DocumentPageViewModel : NavigationBarBaseViewModel
    {
        ...
        public DocumentPageViewModel(ISearchContentService contentService, IDocumentService docService)
        {
